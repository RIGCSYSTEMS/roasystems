...
<br>
        ...
        <input type="text" name="otros_nombres_de_cliente" id="otros_nombres_de_cliente" value="{{$client->otros_nombres_de_cliente}}">
        <br>
        <br>     
        ...
        <input type="text" name="numero_de_expediente" id="numero_de_expediente" value="{{$client->numero_de_expediente}}">
        <br>
        <br>        
        ...
        <input type="text" name="ubicacion_del_despacho" id="ubicacion_del_despacho" value="{{$client->ubicacion_del_despacho}}">
        <br>
        <br>
        ...
        <input type="text" name="cierre_del_numero_de_caja" id="cierre_del_numero_de_caja" value="{{$client->cierre_del_numero_de_caja}}">
        <br>
        <br>
    <button type="submit">
        Editar el cliente
